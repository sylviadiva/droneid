...
registerBlockType( 'psfwl-display-block/psfwl-widget', {
	title: __( 'Product Slider-For-Woocommerce-Lite' ), // Block title.
	...
	edit(props){
		...
		const psfwlite = PSFWL_logos_array;
		...
		//Function to update id attribute
		function changePsfwlId(psfwl_id){
			setAttributes({psfwl_id});
		}
		...
		return createElement('div', {}, [
			...
			createElement( serverSideRender, {
				block: 'psfwl-display-block/psfwl-widget',
			...
			createElement( InspectorControls, {},
				...
				createElement(SelectControl, {
					value: [props.attributes.psfwl_id],
					label: __( 'Product Slider-For-Woocommerce' ),
					onChange: changePsfwlId,
					options: psfwlite,
				}),
				]
				)
